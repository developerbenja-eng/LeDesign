...
export type InterpolationMethodType = 'idw' | 'kriging' | 'natural_neighbor' | 'triangulation' | 'delaunay' | 'constrained_delaunay' | 'spline';
...
export type { SurveyPoint, BoundingBox };
