...
import type { AnyCADEntity, PointEntity, LineEntity, PolylineEntity, CircleEntity, ArcEntity, TextEntity, DimensionEntity, DimensionType, CADLayer, Point3D } from '@/types/cad';
