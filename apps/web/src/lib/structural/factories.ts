...
} from '@/types/structural/elements';
import {
  Material,
  CreateMaterialInput,
  Section,
  CreateSectionInput,
} from '@/types/structural/materials';
import {
  LoadCase,
  CreateLoadCaseInput,
  LoadCombination,
...
} from '@/types/structural/loads';
import {
  AnalysisRun,
  CreateAnalysisRunInput,
} from '@/types/structural/results';
