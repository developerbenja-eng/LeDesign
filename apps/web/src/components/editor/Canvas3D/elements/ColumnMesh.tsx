...
// ============================================================
// COLUMN MESH
// 3D representation of a structural column with section profile
// ============================================================

import { useRef, useState, useMemo } from 'react';
import { ThreeEvent } from '@react-three/fiber';
import { Column, StructuralNode, Section, Material } from '@ledesign/structural';
...
export function ColumnMesh({
  ...
  // Calculate column position, rotation, and length
  ...
  const geometry = useMemo(() => {
    ...
    // Fallback: columns often use W-shapes or HSS
