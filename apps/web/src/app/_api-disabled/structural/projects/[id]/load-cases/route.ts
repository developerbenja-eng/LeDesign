...
import { createLoadCase } from '@ledesign/structural/factories';
import {
  LoadCase,
  CreateLoadCaseInput,
...
export async function PUT(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    const defaultLoadCases = [
      ...
      createLoadCase({ project_id: projectId, name: 'Wind +X', load_type: 'wind', direction: 'X' as const }),
      createLoadCase({ project_id: projectId, name: 'Wind -X', load_type: 'wind', direction: '-X' as const }),
      createLoadCase({ project_id: projectId, name: 'Wind +Y', load_type: 'wind', direction: 'Y' as const }),
      createLoadCase({ project_id: projectId, name: 'Wind -Y', load_type: 'wind', direction: '-Y' as const }),
      createLoadCase({ project_id: projectId, name: 'Seismic X', load_type: 'seismic', direction: 'X' as const }),
      createLoadCase({ project_id: projectId, name: 'Seismic Y', load_type: 'seismic', direction: 'Y' as const }),
    ];
